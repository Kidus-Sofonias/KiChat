  ...
  en: {
    ...
    home: {
      ...
      metrics: [
        ...
        {
          value: "3 languages",
          label: "Shape the interface in English, Kiswahili, or Francais.",
        },
        {
          value: "8 bots",
  ...
  sw: {
    ...
    home: {
      ...
      metrics: [
        ...
        {
          value: "Lugha 3",
          label: "Tengeneza mwonekano wa Kiingereza, Kiswahili, au Francais.",
        },
        {
          value: "Boti 8",
  ...
  fr: {
    ...
    home: {
      ...
      metrics: [
        ...
        {
          value: "3 langues",
          label: "Utilisez English, Kiswahili, ou Francais pour l'interface.",
        },
        {
          value: "8 bots",
